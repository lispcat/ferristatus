...
- signal :: The Unix real-time signal to react to by immediately updating and refreshing.
  - Given this example, running =$ pkill -SIGRTMIN+6 -f ferristatus= will forcefully refresh the Alsa module and re-display.
